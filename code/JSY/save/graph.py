...
class DataExtractor:
    def __init__(
        ...
        When generating an answer, ensure that all relevant information from all related chunks is considered, even if the information is dispersed across multiple chunks or within different parts of a single chunk. The answer should integrate all relevant details to provide a comprehensive and complete response to the question.
        List all discharge capacities (mAh/g) for both pristine and doped electrodes at all specified C-rates (e.g., 0.1C, 5.0C). Include electrode state and any relevant conditions or performance metrics.
    ...
    def retrieve_document(self, state: GraphState) -> GraphState:
        ...
        retrieved_docs = self.retriever.invoke(latest_question, top_k=10)
